...
def test_contract_declares_review_queue_boundaries() -> None:
    ...
    assert "review decision" in contract["output_artifacts"]
    assert "audit trail" in contract["output_artifacts"]
